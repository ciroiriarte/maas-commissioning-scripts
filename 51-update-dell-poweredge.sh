...
# name: 51-update-dell-poweredge.sh
...
# tags: update_firmware update_bios update_bmc
# packages:
#   apt:
#     - libgpgme11
# for_hardware: system_product:R750 vSAN Ready Node,system_product:PowerEdge R740
# may_reboot: true
# recommission: true
# timeout: 01:00:00
